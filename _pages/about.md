...
<main class="home-page">
      ...
      <section class="home-research-group" aria-labelledby="home-working-papers-title">
        ...
        <div class="work-list">
          ...
          <article class="work-entry">
            ...
            <h4><a href="https://arxiv.org/abs/2609.23284">Unbiased Treatment Effect Estimation under Network Interference via Neighborhood-Excluded Cross-Fitting</a></h4>
  ...
  <section class="indexed-section" aria-labelledby="awards-title">
    ...
    <div class="indexed-section__content">
      <ul class="award-list">
        ...
        <li><span>Paper Award, Academic Symposium of the Beijing Biometrics Association</span><time>2025</time></li>
        <li><span>Outstanding Graduate of Tsinghua University</span><time>2022</time></li>
        <li><span>Chinese National Scholarship</span><time>2021</time></li>
      </ul>
    </div>
  </section>
  ...
  <section class="indexed-section contact-section" aria-labelledby="contact-title">
    ...
    <div class="indexed-section__content contact-list">
      ...
      <a href="mailto:yu-haoyang@outlook.com">yu-haoyang@outlook.com</a>
    </div>
  </section>
</main>
